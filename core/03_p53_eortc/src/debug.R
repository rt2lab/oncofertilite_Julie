...
opt            <- NULL
opt$db_name    <- "03_p53_eortc" #TODO : the name of your database
opt$class_name <- "Mappingp53_eortc" #TODO : the name of your class
opt$output_folder <- ""
Sys.setenv("PROJECT_PATH"="/Users/nadir/Desktop/projects/postdoc/DATABASES/databases") #TODO : your PROJECT_PATH

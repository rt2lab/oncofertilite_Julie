...
load( paste0(Sys.getenv("PROJECT_PATH"), "/core/30_julie_subtype/data/oncofert_ER_PR_HER2.RData"))

#Step 1
#Define your Mapping Class
MappingSubtypeJulie <- setClass( #TODO : change the name of the classe (e.g. MappingSein, MappingCanto...)
  "MappingSubtypeJulie", #TODO : same

  # Set the default values for the slots. (optional)
  prototype=list(
    name_database = "30_julie_subtype", #TODO : the name of your base
    #TODO : load your database here e.g.
    database = oncofert_ER_PR_HER2,
...
#Beware : you need to return the whole object of class MappingSubtypeJulie (self)
setMethod(f="mapping_initial",
          signature="MappingSubtypeJulie", #TODO : change to the name of your class
...
setMethod(f="mapping_patient_id",
          signature="MappingSubtypeJulie", #Change here
          definition=function(self)
          {
            ...
            return(list(
              ...
              numdos_curie         = self@database$numdos_curie#,
...
setMethod(f="mapping_patient_char",
          ...
          definition=function(self)
          {
            #TODO : preprocessing variables
            #delay_rfs <- 12*self@database$delay_rfs
            return(list(
...
setMethod(f="mapping_bc_biology",
          ...
          {
            return(list(
              er_status            = factor(self@database$er_status),
              pr_status            = factor(self@database$pr_status),

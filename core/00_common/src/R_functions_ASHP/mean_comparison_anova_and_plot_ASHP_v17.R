variable_to_compare			  <- "perc_stromal_lymphocytes"
variable_to_compare_name	<- "Pre-NAC TILs"

# 								dataf						<- clinical_database
variables_to_test <-  c(anatomical_class,therapeutical_class,pharmacological_class,chemi_thera_pharma_class,chemical_class)
names_variables_to_test <-  c(names_anatomical_class,names_therapeutical_class,names_pharmacological_class,names_chemi_thera_pharma_class,names_chemical_class)

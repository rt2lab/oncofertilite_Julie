...
opt            <- NULL
opt$db_name    <- "28_neoadj_sls" #TODO : the name of your database
opt$class_name <- "MappingNeo_sls" #TODO : the name of your class
opt$output_folder <- ""
...
# ahamypet@u932-ulm-2-57010423x-6209 ~ % export PROJECT_PATH="/Users/ahamypet/RT2Lab/databases"
# ahamypet@u932-ulm-2-57010423x-6209 ~ % cd $PROJECT_PATH;
# ahamypet@u932-ulm-2-57010423x-6209 databases % Rscript core/00_common/src/main.R --db_name=28_neoadj_sls --class_name=MappingNeo_sls --mapping --preprocessing

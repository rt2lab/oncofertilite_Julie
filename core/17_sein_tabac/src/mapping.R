...
MappingpSein_tabac <- setClass(
  ...
  prototype=list(
    name_database = "sein_tabac",
      database = read.csv(paste0(Sys.getenv("PROJECT_PATH"), "/core/17_sein_tabac/data/Tabac_DATA_2021-01-10_2228_2.csv"), sep=',') ###A revoir####
  ),
...
setMethod(f="mapping_initial",
          signature="MappingpSein_tabac", #TODO : change to the name of your class
          definition=function(self)
          {
            #TODO : Modify self@database
 #           source('/Users/bea/GitHUB/databases/core/17_sein_tabac/src/Tabac-Complete_R_2020-06-22_0917.r')
            #self = preprocessBasetabac(self)
          ...
          definition=function(self)
          {
            ...
            return(list(
              ...
              # numdos_curie = self@database$PATID,
               cletri = self@database$record_id
...
setMethod(f="mapping_bc_diagnosis",
          ...
          definition=function(self)
          {
            return(list(
              ...
              multifocality_clin  = factor(self@database$bifocal),
...
setMethod(f="mapping_bc_biology",
          ...
          definition=function(self)
          {
            ...
            histo_5cl[which(self@database$type_histo___4 == 1)] = 9
            
            lvi_biop = rep(NA, nrow(self@database))
            lvi_biop[which(self@database$embole___0 == 1)] = 1
            lvi_biop[which(self@database$embole___1 == 1)] = 0
...
setMethod(f="mapping_surgery",
          ...
          definition=function(self)
          {
            ...
            return(list(
              ...
              breast_surgery      = factor(self@database$ttt_kr___0),
              # TYPCHIR             = paste(self@database$TYPCHIR.f1,self@database$TYPCHIR.f2, self@database$TYPCHIR.f3), ###Normal pour les NAs??? 
              breast_surgery_3cl  = regroup(self@database$chir , list(c(0),c(1,2)), c(1,2))
...
setMethod(f="mapping_tumor_char_neo",
          ...
          definition=function(self)
          {
            breast_res_insitu = rep(NA, nrow(self@database))
            breast_res_insitu[which(self@database$reponse_cna==0)] = 1
            breast_res_insitu[which(self@database$reponse_cna==1)] = 0
            ...
            return(list(
              ...
              pcr = regroup(self@database$reponse_cna , list(c(0,1),c(2)), c(1,0))
            ))
          }
)
...
setMethod(f="mapping_evol",
          ...
          definition=function(self)
          {
            ...
            return(list(
             # status_rfs_diag = factor(self@database$recidiv_cancer)

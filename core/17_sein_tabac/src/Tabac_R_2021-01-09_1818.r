...
library(Hmisc)
#Read Data
data=read.csv('/Users/bea/GitHUB/databases/core/17_sein_tabac/data/Tabac_DATA_2021-01-09_1818.csv') 
#Setting Labels
...
label(data$tobac_life)="Tobacco (at least 100 cig in life)  "
...
data$tobac_life.factor = factor(data$tobac_life,levels=c("1","0"))
...
levels(data$tobac_life.factor)=c("Yes","No")
...
write_csv(data,"/Users/bea/GitHUB/databases/core/17_sein_tabac/data/Tabac_DATA_2021-01-09_1818_2.csv")

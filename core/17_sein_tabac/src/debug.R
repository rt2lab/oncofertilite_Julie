...
opt            <- NULL
opt$db_name    <- "17_sein_tabac" #TODO : the name of your database
opt$class_name <- "MappingpSein_tabac" #TODO : the name of your class
opt$output_folder <- ""
Sys.setenv("PROJECT_PATH"="/Users/bea/GitHUB/databases") #TODO : your PROJECT_PATH
...
load(file.path(output_folder, "17_sein_tabac_mapped.RData"), verbose=TRUE)
# self <- db

...
opt$output_folder <- ""
# setwd("~/RT2Lab/databases") #TODO : your PROJECT_PATH
...
# Then preprocessing
# databases % Rscript core/00_common/src/main.R --db_name=02_neorep --class_name=MappingNeorep --mapping --preprocessing

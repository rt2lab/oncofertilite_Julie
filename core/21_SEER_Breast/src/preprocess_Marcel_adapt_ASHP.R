library(dplyr)
dataset <- readr::read_delim(file = 'databases/core/21_SEER_Breast/data/raw/BC_2010-16_SEER18_30K_2020_AS.tsv',
                             delim = '\t',
...
save(dataset, file = 'databases/core/21_SEER_Breast/data/processed/BC_full_49var.RData')

...
# premiÃ¨re description de la base de donnÃ©e 
...
# on remarque dans un premier temps qu'il y a un nombre de Na trÃ¨s important
# que fait-on des NA ? 
library(psych)
describe(data)
...
# ##################### PremiÃ¨re analyse : dÃ©couverte de la base############################
...
describe(data$age)
# en moyenne, les femmes de l'Ã©chantillon ont 37,8 ans (38 ans); la mÃ©diane est Ã  38 ans. 
# la plus jeune a un peu plus de 22 ans et la plus Ã¢gÃ©e a presque 44 ans. 

hist(data$age, main = "Distribution du nombre de patients en fonction de l'Ã¢ge", xlab = "Ã‚ge", ylab = "Effectif")

#il faut que je crÃ©e une variable numÃ©rique catÃ©gorielle d'Ã¢ge ...

hist(data$age_young_cl, main = "Distribution du nombre de patients en fonction de la classe d'Ã¢ge", xlab = "Ã‚ge", ylab = "Effectif")
